...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{../paper/share/TECHNICAL_ARCHITECTURE_PAPER_SCOPE.png}
...
\centering
\scriptsize
\input{results/latency/latency_mode_summary_table.tex}
\end{table}
...
\centering
\scriptsize
\input{results/device/device_latency_table.tex}
\end{table}
...
\centering
\scriptsize
\input{results/update_metrics/update_metrics_table.tex}
\end{table}
...
\centering
\scriptsize
\input{results/hard_cases/hard_case_taxonomy_table.tex}
\end{table}
