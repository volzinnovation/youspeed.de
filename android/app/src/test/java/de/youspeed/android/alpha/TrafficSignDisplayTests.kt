...
class TrafficSignDisplayTests {
    ...
    @Test fun latestOtherSignReplacesPreviousWhileEmptyFrameRetainsAndSpeedOrUnmappedClears() {
        ...
        assertEquals("tsr/sign-pictograms/png/de-136-10.png", school.imagePath)
        assertEquals("hazard:school", TrafficSignDisplayPolicy.next(second, observe("hazard:school"), catalog)?.classId)
        val bicycle = requireNotNull(catalog.pictogram("hazard:bicycle"))
        assertEquals("tsr/sign-pictograms/png/de-138-10.png", bicycle.imagePath)
        val wildAnimals = requireNotNull(catalog.pictogram("hazard:wild_animals"))
        assertEquals("tsr/sign-pictograms/png/de-142-10.png", wildAnimals.imagePath)
        val wind = requireNotNull(catalog.pictogram("hazard:wind"))
        assertEquals("tsr/sign-pictograms/png/de-117-10.png", wind.imagePath)
