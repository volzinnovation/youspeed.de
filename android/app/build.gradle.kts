...
val releaseBaseVersionCode = providers.gradleProperty("youspeedBuildNumber").orElse("10014").get().toInt()
val releaseVersionName = providers.gradleProperty("youspeedVersionName").orElse("1.1.1").get()
