...
Runtime footprint differs substantially by architecture: S1 uses 7 files (\SI{5.51}{GB}), S2 uses 109{,}333 files (\SI{5.10}{GB}), S3 uses 1 file (\SI{2.89}{GB}), and S4 uses 1 file (\SI{3.44}{GB}).
